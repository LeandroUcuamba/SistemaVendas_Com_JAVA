...
public class FormClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "cod", "nome", "email", "telefone", "cep", "endereco", "numero", "complemento", "estado"
            }
        ) {
        ...
        painelDeGuiasjTabbedPane1.addTab("Consulta de clientes", ConsultaClientesjPanel3);
    ...
    private void tabelaClienteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabelaClienteKeyReleased
        ...
        if(tabelaCliente.getSelectedRow() != -1){
            ...
            txtEmail.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 2).toString());
            txtTelefone.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 3).toString());
            txtCEP.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 4).toString());
            txtEndereco.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 5).toString());
            txtNumero.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 6).toString());
            txtComplemento.setText(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 7).toString());
            cbUF.setSelectedItem(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 8).toString());
